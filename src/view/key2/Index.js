    ...
    render() {
        ...
        return (
            <div>
                <WhiteSpace size="lg"/>
                <WingBlank mode={20}>
                <SegmentedControl selectedIndex={this.props.key2.selectedIndex} values={['读党史', '唱党歌']} onChange={this.handleSegmentedControl.bind(this)}/>
                <WhiteSpace size="lg"/>
                <WhiteSpace size="lg"/>
                {

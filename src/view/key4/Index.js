    ...
    render() {
        ...
        return (
            <div>
                ...
                <WingBlank mode={20}>
                {
                    this.props.key4.step != 2?
                        <div>
                        <SegmentedControl selectedIndex={0} values={['上传微笑照片']}/>
                        <WhiteSpace size="lg"/>
                        <WhiteSpace size="lg"/>
                            <Steps current={this.props.key4.step} direction="horizontal">
                                    ...
                                    <div>
                                        {
                                            ...
                                            this.props.key4.task.task_type === 'PICTURE' ?
                                                <div>
                                                    ...
                                                    <div className="center">
                                                        <Button className="btn center-buttom" type="primary" onClick={this.handleUploadImage.bind(this)}>{this.props.key4.task.task_name}</Button>
                                                    </div>
                                                </div>
                                                :
                                            this.props.key4.task.task_type === 'RECORD' ?
                                                <div>
                                                    <div style={{height: '200px'}}></div>
                                                    <div className="center">
                                                        <Button className="btn center-buttom" type="primary" onClick={this.handleUploadRecord.bind(this)}>{this.props.key4.task.task_name}</Button>
                                                    </div>
                                                </div>
                                                : null
                                        }
                        ...
                        this.props.key4.step == 2 ?
                            <div>
                                ...
                                <div className="center-logo">
                                    <img src={require('../../assets/image/key4.png')} style={{width: document.documentElement.clientWidth, height: document.documentElement.clientWidth + 'px'}} alt=""/>
                                    <WhiteSpace size="lg" />
                                    恭喜你完成任务获得激情钥匙一枚
                                </div>
                            </div>

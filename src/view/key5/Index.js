            ...
            <div>
                ...
                <WingBlank mode={20}>
                {
                    this.props.key5.step != 2?
                        ...
                        <WhiteSpace size="lg"/>
                        <WhiteSpace size="lg"/>
                            <Steps current={this.props.key5.step} direction="horizontal">
                                    ...
                                    <div>
                                        {
                                            ...
                                            this.props.key5.task.task_type === 'PICTURE' ?
                                                <div>
                                                    ...
                                                    <div className="center">
                                                        <Button className="btn center-buttom" type="primary" onClick={this.handleUploadImage.bind(this)}>{this.props.key5.task.task_name}</Button>
                                                    </div>
                                                </div>
                                                :
                                            this.props.key5.task.task_type === 'RECORD' ?
                                                <div>
                                                    <div style={{height: '200px'}}></div>
                                                    <div className="center">
                                                        <Button className="btn center-buttom" type="primary" onClick={this.handleUploadRecord.bind(this)}>{this.props.key5.task.task_name}</Button>
                                                    </div>
                                                </div>
                                                : null
                                        }
